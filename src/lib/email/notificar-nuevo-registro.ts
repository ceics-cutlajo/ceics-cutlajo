  ...
  <div style="max-width:560px;margin:32px auto;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.06);">
    ...
    <div style="padding:28px 32px;">
      ...
      <table style="width:100%;border-collapse:collapse;margin:16px 0;">
        <tr>
          <td style="padding:6px 0;font-size:12px;color:#7a7a7a;text-transform:uppercase;letter-spacing:0.08em;width:38%;">Nombre</td>
          <td style="padding:6px 0;font-size:14px;font-weight:500;">${escapeHtml(i.nombreCompleto)}</td>
        </tr>
        <tr>
          <td style="padding:6px 0;font-size:12px;color:#7a7a7a;text-transform:uppercase;letter-spacing:0.08em;">Correo</td>
          <td style="padding:6px 0;font-size:14px;">${escapeHtml(i.emailNuevo)}</td>
        </tr>
        <tr>
          <td style="padding:6px 0;font-size:12px;color:#7a7a7a;text-transform:uppercase;letter-spacing:0.08em;">Código UdeG</td>
          <td style="padding:6px 0;font-size:14px;">${escapeHtml(i.codigoUdg)}</td>
        </tr>
        <tr>
          <td style="padding:6px 0;font-size:12px;color:#7a7a7a;text-transform:uppercase;letter-spacing:0.08em;">Adscripción</td>
          <td style="padding:6px 0;font-size:14px;">${escapeHtml(i.adscripcion)}</td>
        </tr>
      </table>
      <p style="margin:20px 0 16px 0;font-size:13px;color:#5a5a5a;line-height:1.6;">
        Aún no ha sometido ningún protocolo; recibirás un aviso por separado cuando lo haga.
      </p>
      <div style="text-align:center;margin:24px 0 8px 0;">
        <a href="${linkPadron}" style="display:inline-block;background:#c8266c;color:#ffffff;text-decoration:none;padding:12px 28px;border-radius:8px;font-size:15px;font-weight:500;">
